...
import hu.nagytom.pd.pixeldungeon.actors.mobs.npcs.ImpShopkeeper;
import hu.nagytom.pd.pixeldungeon.actors.mobs.npcs.Shopkeeper;
...
import hu.nagytom.pd.pixeldungeon.items.armor.*;
...
import hu.nagytom.pd.pixeldungeon.items.food.OverpricedRation;
import hu.nagytom.pd.pixeldungeon.items.potions.PotionOfHealing;
import hu.nagytom.pd.pixeldungeon.items.scrolls.ScrollOfIdentify;
import hu.nagytom.pd.pixeldungeon.items.scrolls.ScrollOfMagicMapping;
import hu.nagytom.pd.pixeldungeon.items.scrolls.ScrollOfRemoveCurse;
import hu.nagytom.pd.pixeldungeon.items.weapon.melee.*;
