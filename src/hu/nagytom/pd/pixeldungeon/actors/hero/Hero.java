 ...
 */
package hu.nagytom.pd.pixeldungeon.actors.hero;
...
import hu.nagytom.pd.pixeldungeon.Bones;
...
import hu.nagytom.pd.pixeldungeon.actors.buffs.Combo;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Cripple;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Fury;
import hu.nagytom.pd.pixeldungeon.actors.buffs.GasesImmunity;
...
import hu.nagytom.pd.pixeldungeon.actors.buffs.Ooze;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Paralysis;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Poison;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Regeneration;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Roots;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Charm;
import hu.nagytom.pd.pixeldungeon.actors.buffs.SnipersMark;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Vertigo;
import hu.nagytom.pd.pixeldungeon.actors.buffs.Weakness;
import hu.nagytom.pd.pixeldungeon.actors.mobs.Mob;
import hu.nagytom.pd.pixeldungeon.actors.mobs.npcs.NPC;
import hu.nagytom.pd.pixeldungeon.effects.CheckedCell;
import hu.nagytom.pd.pixeldungeon.effects.Flare;
import hu.nagytom.pd.pixeldungeon.effects.Speck;
import hu.nagytom.pd.pixeldungeon.items.Amulet;
import hu.nagytom.pd.pixeldungeon.items.Ankh;
import hu.nagytom.pd.pixeldungeon.items.DewVial;
import hu.nagytom.pd.pixeldungeon.items.Dewdrop;
import hu.nagytom.pd.pixeldungeon.items.Heap;
import hu.nagytom.pd.pixeldungeon.items.Heap.Type;
...
import hu.nagytom.pd.pixeldungeon.items.potions.PotionOfMight;
import hu.nagytom.pd.pixeldungeon.items.potions.PotionOfStrength;
import hu.nagytom.pd.pixeldungeon.items.rings.RingOfAccuracy;
import hu.nagytom.pd.pixeldungeon.items.rings.RingOfDetection;
import hu.nagytom.pd.pixeldungeon.items.rings.RingOfElements;
import hu.nagytom.pd.pixeldungeon.items.rings.RingOfEvasion;
import hu.nagytom.pd.pixeldungeon.items.rings.RingOfHaste;
import hu.nagytom.pd.pixeldungeon.items.rings.RingOfShadows;
import hu.nagytom.pd.pixeldungeon.items.rings.RingOfThorns;
...
import hu.nagytom.pd.pixeldungeon.items.scrolls.ScrollOfRecharging;
import hu.nagytom.pd.pixeldungeon.items.scrolls.ScrollOfUpgrade;
import hu.nagytom.pd.pixeldungeon.items.scrolls.ScrollOfEnchantment;
...
import hu.nagytom.pd.pixeldungeon.levels.features.AlchemyPot;
import hu.nagytom.pd.pixeldungeon.levels.features.Chasm;
import hu.nagytom.pd.pixeldungeon.levels.features.Sign;
import hu.nagytom.pd.pixeldungeon.plants.Earthroot;
import hu.nagytom.pd.pixeldungeon.scenes.GameScene;
import hu.nagytom.pd.pixeldungeon.scenes.InterlevelScene;
import hu.nagytom.pd.pixeldungeon.scenes.SurfaceScene;
import hu.nagytom.pd.pixeldungeon.sprites.CharSprite;
import hu.nagytom.pd.pixeldungeon.sprites.HeroSprite;
import hu.nagytom.pd.pixeldungeon.ui.AttackIndicator;
