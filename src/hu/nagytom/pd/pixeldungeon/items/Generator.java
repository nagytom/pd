...
import hu.nagytom.pd.pixeldungeon.items.food.Pasty;
import hu.nagytom.pd.pixeldungeon.items.potions.*;
import hu.nagytom.pd.pixeldungeon.items.rings.*;
import hu.nagytom.pd.pixeldungeon.items.scrolls.*;
import hu.nagytom.pd.pixeldungeon.items.wands.*;
import hu.nagytom.pd.pixeldungeon.items.weapon.*;
import hu.nagytom.pd.pixeldungeon.items.weapon.melee.*;
import hu.nagytom.pd.pixeldungeon.items.weapon.missiles.*;
import hu.nagytom.pd.pixeldungeon.plants.*;
