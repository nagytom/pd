 ...
 */
package hu.nagytom.pd.pixeldungeon.items.weapon.enchantments;
...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, hu.nagytom.pd.pixeldungeon.actors.buffs.Poison.class ).
				set( hu.nagytom.pd.pixeldungeon.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );
