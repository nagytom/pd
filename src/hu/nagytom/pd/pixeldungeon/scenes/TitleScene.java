...
import hu.nagytom.pd.pixeldungeon.effects.Fireball;
import hu.nagytom.pd.pixeldungeon.ui.Archs;
import hu.nagytom.pd.pixeldungeon.ui.ExitButton;
import hu.nagytom.pd.pixeldungeon.ui.PrefsButton;
...
public class TitleScene extends PixelScene {
    ...
    public void create() {
        ...
        BitmapText version = new BitmapText( "v " + Game.version + "-modded", font1x );
        version.measure();
